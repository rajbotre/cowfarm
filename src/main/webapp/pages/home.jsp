            ...
            <div class="slider_area">
                ...
                <div id="slides">
                    <ul class="slides-container">
                        <li>
                            <img src="/resources/img/slider/2.jpg" alt="img">
                        ...
                        <!-- Start single slider-->
                        <li>
                            <img src="/resources/img/slider/3.jpg" alt="img">
                        ...
                        <!-- Start single slider-->
                        <li>
                            <img src="/resources/img/slider/4.jpg" alt="img">
                            <div class="slider_caption">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a class="news_img" href="#">
                                            <img class="media-object" src="/resources/img/news.jpg" alt="img">
                                        </a>
                                    </div>
                            ...
                            <ul class="news_tab">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-left">
                                            <a class="news_img" href="#">
                                                <img class="media-object" src="/resources/img/notice.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <a href="#">Dummy text of the printing and typesetting industry</a>
                ...
                <div class="ourCourse_content">
                    <ul class="course_nav">
                        <li>
                            <div class="single_course">
                                <div class="singCourse_imgarea">
                                    <img src="/resources/img/course-1.jpg" />
                                    <div class="mask">
                                ...
                                <div class="singCourse_author">
                                    <img src="/resources/img/author.jpg" alt="img">
                        ...
                        <li>
                            <div class="single_course">
                                <div class="singCourse_imgarea">
                                    <img src="/resources/img/course-2.jpg" />
                                    <div class="mask">
                                        <a href="#" class="course_more">View Course</a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="single_tutors">
                                <div class="tutors_thumb">
                                    <img src="/resources/img/author.jpg" />
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_stsTestimonial wow fadeInUp">
                                ...
                                <img class="stsTesti_img" src="/resources/img/author.jpg" alt="img">
